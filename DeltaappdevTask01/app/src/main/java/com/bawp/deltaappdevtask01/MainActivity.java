...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitAnswer(View view) {
        try {
            ...
            Toast.makeText(getApplicationContext(), "Kindly fill in all boxes before submitting" , Toast.LENGTH_SHORT).show();
        }
    }
